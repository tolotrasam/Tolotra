...
(function ($) {
    ...
    acf.fields.relationship = {
        ...
        fetch: function () {
            ...
            // get results
            // console.log(acf.o.ajaxurl, ' url');
            // console.log(acf.o.post_id, ' postid');
            // console.log(acf.o.nonce + ' nonce');
            // console.log(this.o, ' nonce');
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: $.extend({
                    // action		:	'acf/fields/relationship/query_posts', //custom tolotra, in metabox, in add_ajax_actions();
                    action: 'acf_fields_relationship_query_posts', //custom tolotra, in metabox, in add_ajax_actions();
                    post_id: acf.o.post_id,
                    nonce: acf.o.nonce
                }, this.o),
